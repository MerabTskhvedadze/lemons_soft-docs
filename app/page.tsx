...
export default function Home() {
    ...
    return (
        <>
            ...
            <section className={'flex flex-col gap-3'}>
                <div>
                    <h1 className={'title_font text-lg'}>ჰედერი</h1>
                    <p className={'pl-5'}>
                        ჰედერი აერთიანებს სწრაფ ქმედებებს და სტატუსებს: ლოგო/აპის სახელი, გვერდითი მენიუს
                        გამხსნელი ღილაკი, დროის მაჩვენებლები,
                        დოლარის კურსი, პაუზა/დასრულება, შეტყობინებები და პროფილის პარამეტრები.
                    </p>
                </div>
                ...
                <div className={'pl-3 max-w-full'}>
                    <Table>
                        <TableHeader>
                            <TableRow>
                                <TableHead className={'title_font'}>ელემენტი</TableHead>
                                <TableHead className={'title_font'}>დანიშნულება</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {[
                                {
                                    label: 'ლოგო • LEMONS CRM',
                                    desc: 'აპის იდენტიფიკატორი. დაკლიკებით აბრუნებს /dashboard-ზე.'
                                },
                                {
                                    label: 'გვერდითი მენიუ',
                                    desc: 'ხსნის/კეტავს მარცხენა ნავიგაციას ნებისმიერი გვერდიდან.'
                                },
                                {
                                    label: 'SCRIPTS',
                                    desc: 'სკრიპტების სწრაფი გახსნა (ყიდვის არგუმენტები, FAQ, პასუხების შაბლონები).'
                                },
                                {
                                    label: 'ზარები/ხმა',
                                    desc: 'ზარის მოდულის სტატუსი. აქტიური/არაქტიური და მიკროფონის შემოწმება.'
                                },
                                {
                                    label: 'შენიშვნები',
                                    desc: 'სწრაფი ჩანიშვნების პანელი მიმდინარე ლიდზე/კლიენტზე.'
                                },
                                {
                                    label: 'სამუშაო დრო',
                                    desc: 'დღის მიმდინარე სამუშაო დრო. ითვლება ავტო.–სტარტით შესვლაზე.'
                                },
                                {
                                    label: 'ბალანსი/კურსი',
                                    desc: 'ბალანსი ან ვალუტის კურსი, რომელიც გამოიყენება KPI/პრემიის კალკულაციებში.'
                                },
                                {
                                    label: 'სესიის ქრონომეტრი',
                                    desc: 'სრული სესიის ხანგრძლივობა'
                                },
                                {
                                    label: 'შესვენების ტაიმერი',
                                    desc: 'ბოლო პაუზის/კოფი–ბრეიქის ხანგრძლივობა'
                                },
                                {
                                    label: 'პაუზა/გაგრძელება',
                                    desc: 'აჩერებს/აგრძელებს სამუშაო ქრონომეტრს.'
                                },
                                {
                                    label: 'დასრულება',
                                    desc: 'ცვლის სტატუსს “დასრულებულზე”, აქრობს ზარის მიღებას და ასრულებს სეანსს.'
                                },
                                {
                                    label: 'ელ.ფოსტა',
                                    desc: 'Inbox-ის სწრაფი ნახვა.'
                                },
                                {
                                    label: 'გაფრთხილებები',
                                    desc: 'სისტემური ნოტიფიკაციები: ახალ ლიდებზე, დავალიანებაზე, უფლებებზე.'
                                },
                                {
                                    label: 'პროფილი',
                                    desc: 'პირადი პროფილი, ენა, პაროლი, გამოსვლა.'
                                }
                            ].map((i) => (
                                <TableRow key={i.label}>
                                    <TableCell className={'title_font'}>{i.label}</TableCell>
                ...
                <div className={'pl-5'}>
                    <h2 className={'title_font text-sm'}>ქცევები და სტატუსები</h2>
                    <ul className={'list-disc pl-5 flex flex-col gap-2'}>
                        <li><strong>ფერი = სტატუსი:</strong> მწვანე — აქტიური/წარმატებული; ლურჯი — ინფორმაცია;
                            ნაცრისფერი — ნეიტრალური; ნარინჯისფერი — პაუზა; წითელი — კრიტიკული/დასრულება.
                        </li>
                        <li><strong>ჰოვერ–ტულთიფი:</strong> თითოეულ ბეჯზე ჩანს აღწერა და ცხელი ღილაკების კომბინაციები
                            (თუ გაქვს ჩართული).
                        </li>
                        <li><strong>ტაიმერები:</strong> ითვლება რეალურ დროში; პაუზისას სამუშაო დრო ჩერდება, პაუზის
                            ტაიმერი იწყებს დათვლას.
                        </li>
                        <li><strong>დასრულება:</strong> აკეტებს აქტივ სესიებს (ზარები, ჩანიშვნები) და ლოგავს ოფლაინ
                            სტატუსს.
                        </li>
                    </ul>
                </div>
