        ...
        <>
            ...
            <header className=" flex flex-col gap-3">
                ...
                <ScrollTrailText className="pl-5">
                    ეს გვერდი აჩვენებს <b>მხოლოდ იმ შეხვედრებს, რომლებიც უშუალოდ შენზეა მინიჭებული</b> – როგორც
                    ოპერატორის, ისე გაყიდვების მენეჯერის როლში. ცხრილში ჩანს ვისთან გაქვს შეხვედრა დაგეგმილი,
                    რომელ პროექტს ეხება, სად უნდა გაიმართოს და რა სტატუსზეა პროცესი (დაგეგმილი, დასრულებული,
                    გადავადებული, გაუქმებული და ა.შ.).
                    <br/><br/>
                    „<b>ყველა შეხვედრის</b>“ გვერდთან შედარებით, აქ წარმოდგენილია შენი პირადი სამუშაო სია – მხოლოდ
                    ის ლიდები და შეხვედრები, რომელთა პრიორიტეტიზაციაც, დარეკვაც და შედეგის დაფიქსირებაც
                    უშუალოდ შენს პასუხისმგებლობაშია.
                    <br/><br/>
                    თუ ცხრილი ცარიელია, ამ მომენტში შენზე <b>აქტიური შეხვედრა არ არის მინიჭებული</b> და
                    დამატებითი მოქმედება საჭირო არაა, სანამ ახალი დავალებები არ გადმოგეცემა.
                </ScrollTrailText>
            </header>
