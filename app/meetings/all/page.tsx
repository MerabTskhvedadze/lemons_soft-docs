        ...
        <>
            ...
            <header className=" flex flex-col gap-3">
                <div className={'flex items-center gap-3'}>
                    <ScrollTrailText className={'title_font text-lg'}>🔹 ყველა შეხვედრა</ScrollTrailText>
                </div>

                <ScrollTrailText className="pl-5">
                    ეს გვერდი აჩვენებს <b>სისტემაში დაგეგმილ ყველა შეხვედრას</b> – როგორც ოპერატორების, ისე
                    გაყიდვების მენეჯერების მიერ შექმნილებს. ცხრილში ჩანს ვისთან არის შეხვედრა დაგეგმილი, რომელი
                    პროექტს ეხება, სად უნდა გაიმართოს (მისამართი / ლოკაცია), ვინ არის პასუხისმგებელი აგენტი
                    და რა სტატუსზეა შეხვედრა (დაგეგმილი, დასრულებული, გადავადებული, გაუქმებული და ა.შ.).
                    <br/><br/>
                    გვერდი გამოიყენება მენეჯერებისა და ადმინისტრატორებისთვის, რათა ერთი ეკრანიდან აკონტროლონ
                    <b>ყველა კომერციული შეხვედრის ნაკადი</b> – გაანაწილონ დავალებები, შეამოწმონ შედეგები და
                    საჭიროების შემთხვევაში შეასწორონ თარიღები, მისამართები ან პასუხისმგებელი პირები.
                </ScrollTrailText>
            </header>
