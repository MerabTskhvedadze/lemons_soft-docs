        ...
        <>
            ...
            <header className=" flex flex-col gap-3">
                ...
                <ScrollTrailText className="pl-5">
                    ეს გვერდი აჩვენებს <b>ყველა კომერციულ ობიექტს</b>, რომელიც გაყიდვაშია – ოფისებს,
                    მაღაზიებს, სერვის ცენტრებს, საწყობებს და სხვა კომერციულ ფართებს. აქ ოპერატორები და
                    გაყიდვების მენეჯერები ერთიან ცხრილში იღებენ სრულ სურათს: რომელი ობიექტი რას წარმოადგენს,
                    რა სტატუსზეა ლიდი, ვისთან არის მიმაგრებული და რა ეტაპზეა კომუნიკაცია (შეხვედრა, ზარები,
                    კომენტარები და ა.შ.).
                    <br />
                    <br />
                    ცხრილის ფილტრებისა და ძებნის საშუალებით შეგიძლია სწრაფად მოძებნო სასურველი კომერციული
                    ობიექტი – ლოკაციის, ფართის, პროექტის, პასუხისმგებელი მენეჯერის ან სხვა პარამეტრის მიხედვით
                    და გააკონტროლო მთლიანი კომერციული გაყიდვების ნაკადი ერთი ეკრანიდან.
                </ScrollTrailText>
            </header>
