        ...
        <>
            ...
            <header className=" flex flex-col gap-3">
                ...
                <ScrollTrailText className="pl-5">
                    ჩემი დავალებების გვერდზე წარმოდგენილია ცხრილი რომელშიც ჩანს კონკრეტულ ოპერატორთან გაზიარებული დასამუშავებელი ნომრები,
                    <br/>
                    ამ გვერდზე ასევე ჩანს ოპერატორის მიერ მოთხოვნილი ლიდები, იმ შემთხვევაში თუ იუზერი არის მენეჯერის პოზიციაზე
                    <br/>
                    თუ ცხრილი ცარიელია ოპერატორს არ აქვს დასამუშავებელი ნომრები.
                </ScrollTrailText>
            </header>
