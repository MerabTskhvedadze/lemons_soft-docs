        ...
        <>
            ...
            <header className=" flex flex-col gap-3">
                <div className={'flex items-center gap-3'}>
                    <ScrollTrailText className={'title_font text-lg'}>🔹 ჩემი დავალებები</ScrollTrailText>
                </div>

                <ScrollTrailText className="pl-5">
                    ეს გვერდი აჩვენებს კომერციულ ობიექტებს, რომლებიც კონკრეტულად შენზეა მინიჭებული <b>დავალების სახით</b>.
                    <br/><br/>
                    ცხრილში ჩანს მხოლოდ ის კომერციული ლიდები, სადაც პასუხისმგებელი ოპერატორი ან გაყიდვების
                    მენეჯერი ხარ შენ – აქედან გეგმავ დარეკვებს, შეხვედრებს, კომენტარებს და სტატუსების ცვლილებებს.
                    <br/><br/>
                    თუ ცხრილი ცარიელია, ამ ეტაპზე შენზე <b>არ არის მიბმული აქტიური კომერციული დავალებები</b> – არც
                    ახალი ლიდი და არც გადასამუშავებელი ობიექტი.
                </ScrollTrailText>
            </header>
