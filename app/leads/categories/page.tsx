        ...
        <>
            ...
            <header className="flex flex-col gap-3">
                ...
                <ScrollTrailText className="pl-5">
                    ეს გვერდი გამოიყენება <b>სტატუსებისა და კატეგორიების სამართავად</b> - მარჯვენა მხარეს ხედავ
            ...
            <section className={'pl-5'}>
                        ...
                        <Step
                            ...
                            desc={
                                <>
                                    ...
                                    „დახურული“, „სამუშაო“)
                                    და თითოეულს ქვეშ, ქვეკატეგორიის არსებობის შემთხვევაში, გვხვდება <b>ქვეკატეგორიები</b>(ქვესტატუსი).
                                </>
                            }
                        />
                        ...
                        <Step
                            ...
                            desc={
                                <>
                                    ...
                                    გამოიყენე მხოლოდ მაშინ, თუ ასეთი სტატუსი მომავალში აღარ დაგჭირდება.
                                </>
                            }
                        />
                ...
                <Section title="ველების აღწერა">
                    <List dense>
                        <Bullet title="სახელი">
                            კატეგორიის/სტატუსის სახელი ჩანს სხვა მოდულებში. გამოიყენე მოკლე და კონკრეტული
                        ...
                        <Bullet title="სტატუსი (ჩართვა/გამორთვა)">
                            განსაზღვრავს აქტიურია თუ არა სტატუსი. გამორთული სტატუსი არ ჩანს სოფტში, წაშლის გარეშე.
                        </Bullet>
                        ...
                        <Step
                            ...
                            desc={
                                <>
                                    ...
                                    ასე შეგიძლია მოარგო სტატუსების თანმიმდევრობა შენი სამუშაო პროცესის მიხედვით.
                                </>
                            }
                        />
                    </List>
