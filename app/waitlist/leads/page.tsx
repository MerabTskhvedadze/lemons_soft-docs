        ...
        <>
            ...
            <header className=" flex flex-col gap-3">
                <div className={'flex items-center gap-3'}>
                    <ScrollTrailText className={'title_font text-lg'}>🔹 მომლოდინე ლიდები</ScrollTrailText>
                </div>

                <ScrollTrailText className="pl-5">
                    ეს გვერდი აჩვენებს <b>ყველა ლიდს, რომელიც მოლოდინშია</b> – ჯერ არ არის სრულად დამუშავებული
                    ან ოპერატორზე/მენეჯერზე მინიჭებული. აქ ჩანს ნომრები, რომლებიც სისტემაში უკვე შემოვიდა, მაგრამ
                    ჯერ კიდევ ელოდება დარეკვას, გაფილტვრას, ან კონკრეტულ თანამშრომელზე გადანაწილებას.
                    <br/><br/>
                    გვერდი განსაკუთრებით სასარგებლოა მენეჯერებისთვის და ადმინისტრატორებისთვის: შეუძლიათ ერთ
                    ეკრანზე დაინახონ <b>დაგროვილი მოლოდინის რიგი</b>, გაანაწილონ ლიდები ოპერატორებზე, შეამოწმონ,
                    რაიმე ნაწილი ხომ არ „ჩაიკარგა“ პროცესში და მართონ დატვირთვა გუნდებს შორის.
                    <br/><br/>
                    თუ ცხრილში ლიდების რაოდენობა მაღალია, რეკომენდებულია რეგულარულად გამოიყენო ფილტრები
                    (თარიღი, პროექტი, სტატუსი და სხვ.), რათა სწრაფად იპოვო პრიორიტეტული ლიდები და დროულად
                    გადაიყვანო ისინი დამუშავების ეტაპზე.
                </ScrollTrailText>
            </header>
