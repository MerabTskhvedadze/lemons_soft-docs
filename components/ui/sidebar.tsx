    ...
    if (collapsible === "none") {
        return (
            <div
                data-slot="sidebar"
                className={cn(
                    // removed bg color here too (transparent by default)
        ...
        return (
            <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
                <SheetContent
                    ...
                    data-slot="sidebar"
                    data-mobile="true"
                    // keep mobile bg if you like; remove next line if you also want transparent on mobile
        ...
        >
            ...
            <div
                ...
                className={cn(
                    ...
                    position === "fixed"
                        ...
                        : ["relative h-full"],
                    // removed edge borders entirely:
                    // (previously had group-data-[side=left]:border-r / group-data-[side=right]:border-l)
                    variant === "floating" || variant === "inset"
            ...
            >
                <div
                    ...
                    // 🔥 no background & no default border; still keeps floating variant’s border/shadow if you use that variant
